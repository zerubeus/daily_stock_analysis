...
class HistoryService:
    ...
    def _generate_single_stock_markdown(
        ...
        report_lines = [
            ...
            "",
            f"> Analysis Date: **{report_date}** | Report Generated: {report_time}",
            "",
            "---",
            "",
        ]
        ...
        if data_persp:
            ...
            if price_data:
                ...
                bias_emoji = "✅" if bias_status == "Safe" else ("⚠️" if bias_status == "Warning" else "🚨")
                report_lines.extend([
                    "| Price Metric | Value |",
                    "|---------|------|",
        ...
        if not dashboard:
            ...
            if result.buy_reason:
                report_lines.extend([
                    f"**💡 Buy Reason**: {result.buy_reason}",
                    "",
                ])
            # 风险提示
